...
export const courses: Course[] = [
  ...
  },
  {
    ...
    curriculum: [
      {
        ...
        content: "This module introduces you to the fundamentals of React, its architecture, and how it fits into the modern web development ecosystem.",
        resources: [
          { name: "React Documentation", type: "PDF", url: "https://reactjs.org/docs" },
          { name: "Introduction to React", type: "Video", url: "https://example.com/intro-to-react" }
        ],
        quiz: {
          questions: [
            {
              ...
              options: [
                ...
                "A complete framework for web development",
        ...
        assignment: {
          ...
          description: "Create a new React application using Create React App and modify the starter code to display a personalized greeting message."
        },
        videoLectures: [
          {
            title: "Introduction to React",
            url: "https://example.com/intro-to-react-video",
            duration: "45 minutes",
            provider: "YouTube"
          },
          {
            title: "Setting Up Your Development Environment",
            url: "https://example.com/react-setup-video",
            duration: "30 minutes",
            provider: "Vimeo"
          }
        ],
      ...
      },
      {
        ...
        content: "Learn how to create reusable components and pass data between them using props. Master the component lifecycle and understand the difference between functional and class components.",
        resources: [
          { name: "Component API Reference", type: "PDF", url: "https://example.com/component-api.pdf" },
          { name: "Props vs State", type: "Article", url: "https://example.com/props-vs-state" }
        ],
        quiz: {
          questions: [
            {
        ...
        assignment: {
          ...
          description: "Create a small library of reusable components including a Button, Card, and Navigation component that accept various props for customization."
        },
        videoLectures: [
          {
            title: "Understanding React Components",
            url: "https://example.com/react-components-video",
            duration: "50 minutes",
            provider: "YouTube"
          },
          {
            title: "Working with Props",
            url: "https://example.com/react-props-video",
            duration: "40 minutes",
            provider: "YouTube"
          }
        ],
        pdfNotes: [
          {
            ...
            url: "https://example.com/component-patterns.pdf",
            pages: 30
          }
        ],
        learningOutcomes: [
          "Create and use functional and class components",
      ...
      {
        title: "Module 3: State & Lifecycle",
        content: "Dive deep into React's state management and component lifecycle. Learn how to manage local component state, handle side effects, and optimize performance.",
        resources: [
          { name: "React Hooks Documentation", type: "PDF", url: "https://example.com/hooks-docs.pdf" },
          { name: "Understanding React Lifecycle", type: "Article", url: "https://example.com/lifecycle-methods" }
        ],
        quiz: {
          questions: [
            {
            ...
            {
              question: "What is the equivalent of componentDidMount using hooks?",
              options: [
                "useEffect(() => {}, [])",
                "useEffect(() => {})",
                "useState(() => {})",
            ...
            },
            {
              ...
              options: [
                ...
                "When either props or state changes",
        ...
        assignment: {
          title: "Building a Stateful Application",
          description: "Create a task management application that allows users to add, edit, complete, and delete tasks using React state management."
        },
        videoLectures: [
          {
            title: "Understanding React State",
            url: "https://example.com/react-state-video",
            duration: "55 minutes",
            provider: "YouTube"
          },
          {
        ...
        pdfNotes: [
          {
            ...
            url: "https://example.com/state-patterns.pdf",
            pages: 35
          }
        ],
        learningOutcomes: [
          ...
          "Use useState and useEffect hooks correctly"
        ],
        difficultyLevel: "Intermediate"
      },
    ...
    resources: [
      { name: "React Official Documentation", type: "Website", url: "https://reactjs.org" },
      { name: "Modern React with Redux", type: "Course", url: "https://example.com/react-redux-course" },
      { name: "React Design Patterns", type: "E-Book", url: "https://example.com/react-patterns-ebook" }
    ],
  },
  {
    id: 6,
